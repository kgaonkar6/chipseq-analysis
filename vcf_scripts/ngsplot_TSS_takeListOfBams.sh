...
SOURCE_DIR=/data5/bsi/bioinf_ext1/s115547.Chip-Seq/references/annotation/mm10/
...
WORK_DIR=/data2/delivery/Westendorf_Jennifer_mrk4884/150716_SN725_0502_BC77AGACXX/tertiary/ngsplot/5KAroundTSS           #<=====
...
###### human data
OUT_DIR=/data2/delivery/Westendorf_Jennifer_mrk4884/150716_SN725_0502_BC77AGACXX/tertiary/ngsplot/5KAroundTSS   # <======
...
then
     ...
     if [[ $PLOT_LEVEL = "gene" ]]
     then
     ANNO_FILE=${SOURCE_DIR}"/"refGene.Genes.mm10.txt
